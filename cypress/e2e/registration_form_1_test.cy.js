...
describe('This is first test suite, Joonas-Kaarel Ranne', () => { 
        //Today=23.09.2024
    it('User can submit data only when valid mandatory values are added', () => {''
        cy.get('[data-testid="phoneNumberTestId"]').type('555666777')
        cy.get('input[name="firstName"]').type('Anyfirstname')
        cy.get('input[name="lastName"]').type('Anylastname')
    ...
    it('User can use only same both first and validation passwords', () => {
        cy.get('#username').type('Anyfirstname')
        cy.get('[data-testid="phoneNumberTestId"]').type('555666777')
        cy.get('input[name="password"]').type('Parool123')
        cy.get('[name="confirm"]').type('Parool123123')
    ...
    */
    ...
    it('User cannot add letters to phone number', () => {
        ...
        cy.get('#username').type('Anyfirstname')
        cy.get('[data-testid="phoneNumberTestId"]').type('AAA')
        cy.get("input[name='password']").type('Parool123')
        cy.get('[name="confirm"]').type('Parool123')
